<?php $this->set('title_for_layout', __d('cms', 'Adding') . ' &bull; ' . __d('cms', 'Blog Categories')); ?><h2>
    <?php echo __d('cms', 'Admin Edit Blog Category'); ?></h2>
...
<div class="actions">
    ...
    <ul>
        ...
        <?php echo $this->Permissions->link(__d('cms', 'List Blog Categories'), array('action' => 'index'), array('outter' => '<li>%s</li>')); ?>
