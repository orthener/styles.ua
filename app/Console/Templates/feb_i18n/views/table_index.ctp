	...
	echo "\t<tr data-id=\"<?php echo \${$singularVar}['{$modelClass}']['{$primaryKey}']; ?>\">\n";
		...
		echo "\t\t\t<?php //echo \$this->Permissions->link(__('View'), array('action' => 'view', \${$singularVar}['{$modelClass}']['{$primaryKey}'])); ?>\n";
	 	...
	 	echo "\t\t\t<?php //echo \$this->Permissions->postLink(__('Delete'), array('action' => 'delete', \${$singularVar}['{$modelClass}']['{$primaryKey}']), null, __('Are you sure you want to delete # %s?', \${$singularVar}['{$modelClass}']['{$displayField}'])); ?>\n"; ?>
            ...
            <div class="button"><?php echo __d('cms', 'Edit'); ?><br /> <?php
	 	echo "\t\t\t\t<?php echo \$this->Html->div('clearfix', \$this->element('Translate.flags/flags', array('url' => array_merge(array('action' => 'edit', \${$singularVar}['{$modelClass}']['{$primaryKey}'])), 'active' => \${$singularVar}['translateDisplay'], 'title' => __d('cms', 'Edit')))); ?>\n"; ?>
            </div>
        <?php 
        
        echo "\t\t\t<?php echo \$this->element('Translate.flags/trash', array('data' => \${$singularVar}, 'model' => '{$modelClass}')); ?>\n";
		echo "\t\t</td>\n";
	echo "\t</tr>\n";
