...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                '<div class="qq-upload-drop-area"><span>Przeciagnij tutaj plik</span></div>' +
        ...
        fileTemplate: '<li style="display: none">' +
                ...
                '<a style="display: none" class="qq-upload-cancel" href="#">Anuluj</a>' +
                '<span style="display: none" class="qq-upload-failed-text">Bląd</span>' +
            '</li>',        
