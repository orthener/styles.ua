<?php $this->set('title_for_layout', __d('cms', 'List') . ' &bull; ' . __d('cms', 'Blog Categories')); ?>
...
<div class="actions">
    ...
    <ul>
        <?php echo $this->Permissions->link(__d('cms', 'New Blog Category'), array('action' => 'add'), array('outter' => '<li>%s</li>')); ?>
