...
//        echo $this->Html->css(array('reset', 'tinymce', 'default', 'fontello', 'minimal/minimal'));
        ...
        echo $this->Html->css('product-filter');
        echo $this->Html->css(array('bootstrap.min', 'bootstrap-responsive.min', 'ion.rangeSlider.skinNice', 'ion.rangeSlider', '../font/fonts.css', 'font-awesome', 'default', 'select2/select2', 'sliderimg'));
        echo $this->fetch('css');
...
//        echo $this->Html->script('jquery.icheck.min');
        ...
        echo $this->Html->script('ion.rangeSlider');
        echo $this->Html->script('select2/select2.min.js');
        //echo $this->Html->script('script.all');
...
<!--                    <script src="http://vkontakte.ru/js/api/openapi.js" type="text/javascript"></script>
        <script type="text/javascript">
            VK.init({
                apiId: 2153892, //10141841 - id inne
                onlyWidgets: true
            });
        </script>-->
        ...
        <script type="text/javascript">
            VK.init({apiId: 4598527, onlyWidgets: true});
        </script>
<script>
    ...
    <body class="<?php echo $isFront ? 'front' : ''; ?> <?php echo $siteType; ?> ">
            ...
            <div id="topMenu">
                <div class="container">
                    ...
                    <div id="menu-shop" class="row-fluid">
                        ...
                        <div class="span4 mini-cart my-span4 bt-no-margin">
        ...
        <script type="text/javascript">
            ...
            $('.openRight').click(function() {
                ...
                if (!($('body.front.default .openRight').hasClass('clicked'))) {
                    $('body.front.default .openRight').css({'right': '194px'}).addClass('clicked');
                } else {
                    $('body.front.default .openRight').css({'right': '0px'}).removeClass('clicked');
                }
                return false;
            })
            //]]>
