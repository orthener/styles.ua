<div class="categories index">
    ...
    if (isset($this->params['pass']['1']) and $this->params['pass']['1'] == 'shop') {
        $idTab = 1;
    }
    elseif (isset($this->params['pass']['1']) and $this->params['pass']['1'] == 'blog') {
        $idTab = 2;
    }
    elseif (isset($this->params['pass']['1']) and $this->params['pass']['1'] == 'studio') {
        $idTab = 3;
    }
