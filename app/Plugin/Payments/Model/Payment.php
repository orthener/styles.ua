...
class Payment extends AppModel {
    ...
    * @var string
    */
	public $order = 'Payment.created DESC';
    /**
...
//			),
			...
			'title' => array(
				'notempty' => array(
					'rule' => array('notempty'),
					'message' => __d('cms', 'Podaj tytuł płatności'),
					//'allowEmpty' => false,
					//'required' => false,
					//'last' => false, // Stop validation after this rule
					//'on' => 'create', // Limit validation to 'create' or 'update' operations
            ...
            'amount' => array(
                'notempty' => array(
                    'rule' => array('notempty'),
                    'message' =>  __d('cms', 'Podaj kwote płatności'),
                    //'allowEmpty' => false,
                    'required' => false,
                    //'last' => false, // Stop validation after this rule
                    //'on' => 'create', // Limit validation to 'create' or 'update' operations
            ...
            'payment_date' => array(
                'notempty' => array(
                    'rule' => array('notempty'),
                    'message' =>  __d('cms', 'Podaj datę płatności'),
                    //'allowEmpty' => false,
                    'required' => false,
                    //'last' => false, // Stop validation after this rule
                    //'on' => 'create', // Limit validation to 'create' or 'update' operations
...
//        $params['conditions']['OR']["Payment.title LIKE"] = "%{$fraz}%";
//        $params['limit'] = 5;
//        $this->recursive = 1;        
...
//    }
                ...
                $params = array(
                    'post' => array(
                        ...
                        'data' => array(
                            ...
                            'first_name' => $data['Payment']['platnosci_firstname'],
                            'last_name' => '',
                            'language' => 'pl',
    ...
    function getUserPaymentData($payment_id){
        ...
        $data['User'] = $userData[$payment['Payment']['user_model']];
