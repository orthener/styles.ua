        ...
        foreach ($settings AS $setting) {
            ...
            echo '<div class="setting">';
                ...
                if ($setting['Setting']['input_type'] == 'checkbox') {
                    ...
                    echo $this->FebTinyMce->input("Setting.$i.value", array(
                        'label' => $label,
                        'type' => $inputType,
                ...
                } elseif ($setting['Setting']['input_type'] == 'radio' || $setting['Setting']['input_type'] == 'select') {
                    echo $this->Form->input("Setting.$i.value", array(
                        'label' => $label,
                        'type' => $inputType,
                        'value' => $setting['Setting']['value'],
                        'rel' => $setting['Setting']['description'],
                        'title' => $setting['Setting']['description'],
                        'options' => json_decode($setting['Setting']['params'], true)
                    ));
                } else {
                    echo $this->Form->input("Setting.$i.value", array(
                        'label' => $label,
