        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                var placeHTML = function () {
                    ...
                    if (!settings.hideMinMax) {
                        $fieldMin.html(prettify(settings.min) + settings.prefix +  settings.postfix);
                        $fieldMax.html(prettify(settings.max) + settings.prefix +  settings.postfix);
                ...
                var setFields = function () {
                    ...
                    if (settings.type === "single") {
                        ...
                        if (!settings.hideText) {
                            ...
                            _single = 
                                prettify(numbers.fromNumber) + settings.prefix +
                                settings.postfix;
                        ...
                        if (!settings.hideText) {
                            _from = 
                                ...
                                settings.postfix;
                            _to = 
                                prettify(numbers.toNumber) + settings.prefix +
                                settings.postfix;
                        ...
                        $('#price_from').attr("value", parseInt(numbers.fromNumber, 10));
                        $('#price_to').attr("value", parseInt(numbers.toNumber, 10));
