...
if (!isset($tree)) {
    $tree = $this->Html->requestAction(array('controller' => 'comments', 'action' => 'index', 'admin' => false, 'user' => false), array('pass' => array()));
}
...
if (empty($is_ajax)) {
    ...
    <ul id="categories">
        ...
        <li id="category">
            <?php echo $this->element('draw', array('treeMode' => $treeMode, 'data' => $tree, 'FirstJsTrue' => true, 'plugin' => 'comment')); ?>
        </li>
    </ul>
