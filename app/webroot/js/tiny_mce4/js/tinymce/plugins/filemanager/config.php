...
$root = rtrim($_SERVER['DOCUMENT_ROOT'],'/') . "/app/webroot"; // don't touch this configuration
//debug($root);
//debug($_SERVER);
//**********************
//Path configuration
...
//$base_url="http://ko24.local/app/webroot/";
//print_r(realpath('.'));
//$base_url= $root . "/js/tiny_mce4/plugins/filemanager";
//$base_url= $root;
$base_url = "";
$upload_dir = '/uploaded/';
