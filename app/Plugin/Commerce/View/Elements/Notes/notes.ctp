    ...
    <div id="notes-<?php echo $note['id'] ?>">
        <fieldset>
            <legend><b><?php echo isSet($users[$note['user_id']])?$users[$note['user_id']]:'---'; ?></b> 
                ...
                <?php // echo $this->Js->link($this->Html->image('delete.png'), array('controller' => 'notes', 'action' => 'delete', $note['id']), array('title' => 'Usuń', 'update' => '#notes-' . $note['id'], 'escape' => false, 'confirm' => __('Na pewno usunąć wiadomość?', true))); ?>    
                <?php //echo $html->image('comment.png', array('url' => '#', 'title' => 'Komentuj'));   ?>
            </legend>
